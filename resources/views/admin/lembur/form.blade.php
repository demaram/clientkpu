...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0">Edit Data Lembur</h1>
        <ol class="breadcrumb float-sm-right mb-0">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.lembur.index') }}">Data Lembur</a></li>
            ...
            <div class="card card-primary">
                ...
                <form method="POST" action="{{ route('admin.lembur.update', $lembur->id) }}" id="formEditLembur" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <p class="form-control-static mt-2">
                                    {{ $lembur->user ? $lembur->user->first_name . ' ' . $lembur->user->last_name : '-' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input
                                    ...
                                    value="{{ old('start', $lembur->start ? date('Y-m-d\TH:i', strtotime($lembur->start)) : '') }}"
                                    required
                                >
                                @error('start')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input
                                    ...
                                    value="{{ old('end', $lembur->end ? date('Y-m-d\TH:i', strtotime($lembur->end)) : '') }}"
                                    required
                                >
                                @error('end')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.lembur.index') }}" class="btn btn-default ml-2">
