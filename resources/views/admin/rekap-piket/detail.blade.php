...
@section('title', 'Detail Rekap Piket')

@section('content_header')
    <h1>Detail Rekap Piket</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Detail Rekap Piket</h3>
            <a href="{{ route('admin.rekap-piket.index') }}" class="btn btn-default btn-sm">
        ...
        <div class="card-body">
            ...
            <h5>Daftar Piket per Karyawan</h5>
